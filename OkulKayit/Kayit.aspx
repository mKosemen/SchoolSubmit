<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Kayit.aspx.cs" Inherits="OkulKayit.Kayit" %>
...
<head>
    ...
    <!-- Custom-Files -->
    <link href="School/css/bootstrap.css" rel='stylesheet' type='text/css' />
    <!-- Bootstrap-CSS -->
    <link href="School/css/style.css" rel='stylesheet' type='text/css' />
    <!-- Style-CSS -->
    <link href="School/css/font-awesome.min.css" rel="stylesheet">
                ...
                <div class="nav_w3ls ml-lg-5">
                    <nav>
                        ...
                        <ul class="menu">
                            ...
                            <li><a href="Kayit.aspx">Kayit Ol</a></li>
                        </ul>
                    </nav>
                </div>
                <!-- //nav -->
            ...
            <div class="modal-body mt-md-2 mt-5">
                ...
                <form action="#" method="post" runat="server">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="TextBox2" runat="server" CssClass="form-control" placeholder="mail@email.com"></asp:TextBox>
                    </div>
                    <div class="form-group">
                    ...
                    <asp:Button ID="BtnKayit" runat="server" Text="Kaıt Ol" class="btn btn-primary" OnClick="Button_Click" />
                </form>
            </div>
            <!-- //register -->
        </div>
